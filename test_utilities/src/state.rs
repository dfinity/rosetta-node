...
use ic_replicated_state::{
    metadata_state::Stream, page_map, CallContext, CallOrigin, CanisterState, CanisterStatus,
    ExecutionState, ExportedFunctions, NumWasmPages, PageMap, ReplicatedState, SchedulerState,
    SystemState,
};
use ic_types::{
    messages::Ingress,
...
impl SystemStateBuilder {
    ...
    pub fn initial_cycles(mut self, cycles: Cycles) -> Self {
        self.system_state.cycles_account.set_balance(cycles);
        self
    }
