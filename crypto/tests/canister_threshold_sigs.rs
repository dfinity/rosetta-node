...
use ic_types::crypto::canister_threshold_sig::{
    PreSignatureTranscript, ThresholdSignatureInputs, ThresholdSignatureMsg,
};
...
fn fake_sig_inputs() -> ThresholdSignatureInputs {
    let fake_presig_transcript = PreSignatureTranscript {
        kappa: IDkgTranscriptId(1),
        lambda: IDkgTranscriptId(1),
        mu: IDkgTranscriptId(1),
        omega: IDkgTranscriptId(1),
    };
