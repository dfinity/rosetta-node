...
mod keygen {
    ...
    use crate::crypto_lib::basic_sig::ecdsa::{
        new_keypair, public_key_from_cose, public_key_from_der,
    };
...
mod sign {
    use super::*;
    use crate::crypto_lib::basic_sig::ecdsa::{
        new_keypair, sign, signature_from_der, types, verify,
    };
...
mod verify {
    ...
    use crate::crypto_lib::basic_sig::ecdsa::types::{PublicKeyBytes, SignatureBytes};
    use crate::crypto_lib::basic_sig::ecdsa::{public_key_from_cose, signature_from_der, verify};
    use ic_crypto_internal_test_vectors::test_data;
