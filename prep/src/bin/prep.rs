...
fn main() -> Result<()> {
    ...
    let ic_config0 = IcConfig::new(
        ...
        Some(valid_args.replica_download_url),
...
fn parse_nodes_deprecated(src: &str) -> Result<Node> {
    ...
    let p2p_addr: Url = format!("org.dfinity.p2p1://{}", parts[2]).parse()?;
    ...
    fn valid_nodes_hyphen() {
        ...
        let want = Node {
            ...
            config: NodeConfiguration {
                ...
                p2p_addr: "org.dfinity.p2p1://1.2.3.4:80".parse().unwrap(),
                p2p_num_flows: 0,
                p2p_start_flow_tag: 0,
                node_operator_principal_id: None,
            },
...
mod test_flag_node_parser {
    ...
    const GOOD_FLAG: &str = r#"idx:1,subnet_idx:2,xnet_api:["http://1.2.3.4:81"],public_api:["http://3.4.5.6:82"],private_api:["http://3.4.5.6:83"],prometheus_metrics:["http://5.6.7.8:9090"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#;
    ...
    fn missing_fields() {
        ...
        let flags = vec![
            r#"subnet_idx:2,xnet_api:["http://1.2.3.4:81"],public_api:["http://3.4.5.6:82"],private_api:["http://3.4.5.6:83"],prometheus_metrics:["http://5.6.7.8:9090"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#,
            // Omitting subnet index yields an unassigned node.
            // r#"idx:1,xnet_api:["http://1.2.3.4:81"],public_api:["http://3.4.5.6:82"],private_api:["http://3.4.5.6:83"],prometheus_metrics:["http://5.6.7.8:9090"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#,
            r#"idx:1,subnet_idx:2,public_api:["http://3.4.5.6:82"],private_api:["http://3.4.5.6:83"],prometheus_metrics:["http://5.6.7.8:9090"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#,
            r#"idx:1,subnet_idx:2,xnet_api:["http://1.2.3.4:81"],private_api:["http://3.4.5.6:83"],prometheus_metrics:["http://5.6.7.8:9090"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#,
            // TODO(O4-41): Omitting private_api is currently OK.
            //r#"idx:1,subnet_idx:2,xnet_api:["http://1.2.3.4:81"],public_api:["http://3.4.5.6:82"],prometheus_metrics:["http://5.6.7.8:9090"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#,
            r#"idx:1,subnet_idx:2,xnet_api:["http://1.2.3.4:81"],public_api:["http://3.4.5.6:82"],private_api:["http://3.4.5.6:83"],p2p_addr:"org.dfinity.p2p1://1.2.3.4:80""#,
