...
pub struct RegistryDelta {
    ...
    pub values: ::std::vec::Vec<RegistryValue>,
}
...
pub struct RegistryGetChangesSinceResponse {
    ...
    pub error: ::std::option::Option<RegistryError>,
    ...
    pub deltas: ::std::vec::Vec<RegistryDelta>,
}
...
pub struct RegistryAtomicMutateRequest {
    ...
    pub mutations: ::std::vec::Vec<RegistryMutation>,
    /// Preconditions at the key level.
    #[prost(message, repeated, tag="5")]
    pub preconditions: ::std::vec::Vec<Precondition>,
}
...
pub struct RegistryAtomicMutateResponse {
    ...
    /// will set this error.
    #[prost(message, repeated, tag="1")]
    pub errors: ::std::vec::Vec<RegistryError>,
    /// The last version of the registry.
    #[prost(uint64, tag="2")]
    pub version: u64,
}
...
pub struct CertifiedResponse {
    ...
    /// issued.
    #[prost(message, optional, tag="1")]
    pub hash_tree: ::std::option::Option<::ic_protobuf::messaging::xnet::v1::MixedHashTree>,
